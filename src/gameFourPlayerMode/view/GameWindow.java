...
public class GameWindow extends JFrame {
	...
	public void refresh() {
		...
		String playerName= sessionData.getPlayerName(gameSession.turn.player);
			
		turnMessage.setText(playerName+"'s Turn "+(sessionData.getMove(gameSession.turn.player)+1));
